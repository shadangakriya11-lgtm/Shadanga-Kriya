...
import { ArrowRight, Sparkles, Play, CheckCircle, Heart, Brain, Sunrise, Moon, Shield, Users, BarChart3, Star, Quote } from 'lucide-react';
...
const testimonials = [
  {
    ...
    content: "Shadanga Kriya has transformed my daily practice. The guided audio sessions help me achieve deeper states of meditation than ever before.",
    rating: 5,
  ...
  },
  {
    ...
    content: "We've integrated Shadanga Kriya into our therapy programs. The structured approach and progress tracking have significantly improved patient outcomes.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The distraction-free experience is exactly what my clients needed. It keeps them focused and committed to their healing journey.",
    rating: 5,
...
const features = [
  {
    ...
    description: "Carefully crafted audio content designed to guide you through authentic Shadanga Kriya practices.",
    gradient: "from-teal-500 to-cyan-500"
  },
  {
    icon: Shield,
    title: "Focused Environment",
    description: "Zero distractions. Our controlled playback ensures you complete each session for maximum benefit.",
    gradient: "from-amber-500 to-orange-500"
  },
  {
    icon: Sunrise,
    title: "Daily Rituals",
    description: "Establish powerful morning and evening routines with pre-session protocols and guided breathing.",
    gradient: "from-teal-600 to-teal-400"
  }
];

const journeySteps = [
  { step: "01", title: "Begin", description: "Create your account and set your intentions" },
  { step: "02", title: "Practice", description: "Follow guided audio sessions at your own pace" },
  { step: "03", title: "Transform", description: "Track progress and witness your transformation" }
];
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div 
          ...
          style={{ 
            background: 'radial-gradient(circle, hsl(174 65% 40% / 0.3) 0%, transparent 70%)',
        ...
        <div 
          ...
          style={{ 
            background: 'radial-gradient(circle, hsl(38 85% 55% / 0.3) 0%, transparent 70%)',
        ...
        <div 
          ...
          style={{ 
            background: 'radial-gradient(circle, hsl(180 55% 35% / 0.25) 0%, transparent 70%)',
          ...
          <div className="container mx-auto px-6 py-20 md:py-32">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <div 
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary/10 to-teal-500/10 border border-primary/20 mb-8 animate-fade-in"
                >
                  <Sparkles className="h-4 w-4 text-primary" />
                  <span className="text-sm font-medium text-primary">Ancient Wisdom, Modern Practice</span>
                </div>
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-in-up animation-fill-both animate-delay-200">
                  Experience the transformative power of Shadanga Kriya through guided audio sessions designed for deep healing and spiritual growth.
                </p>
              ...
              <div className="relative hidden lg:flex items-center justify-center animate-fade-in-scale animation-fill-both animate-delay-400">
                <div className="relative">
                  ...
                  {/* Floating elements */}
                  <div className="absolute -top-8 -right-8 w-16 h-16 rounded-2xl bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '0.5s' }}>
                    <Sunrise className="h-8 w-8 text-white" />
                  </div>
                  <div className="absolute -bottom-4 -left-8 w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg animate-float" style={{ animationDelay: '1s' }}>
            ...
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="font-serif text-3xl md:text-4xl font-bold gradient-text-brand mb-1">{stat.value}</div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-in-up animate-delay-100">
                Our platform combines ancient yogic practices with modern technology to deliver a truly transformative experience.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {features.map((feature, index) => (
                ...
                >
                  <div className={`h-16 w-16 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="group brand-card p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Immersive audio therapy with strict playback rules, offline support, and pre-session breathing protocols.
                  </p>
                  <ul className="space-y-3 mb-6">
                    {['Guided meditations', 'Progress tracking', 'Offline access'].map((item, i) => (
                  ...
                  >
                    Start as Learner <ArrowRight className="h-4 w-4 ml-1 inline" />
                  </Button>
                </div>
              </div>
              ...
              <div className="group brand-card p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <ul className="space-y-3 mb-6">
                    {['User management', 'Course control', 'Analytics & reports'].map((item, i) => (
                      <li key={i} className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  >
                    Access as Admin <ArrowRight className="h-4 w-4 ml-1 inline" />
                  </Button>
                </div>
              </div>
              ...
              <div className="group brand-card p-8 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Tablet-friendly interface for facilitators to mark attendance, supervise sessions, and view reports.
                  </p>
                  <ul className="space-y-3 mb-6">
                    {['Attendance tracking', 'Session supervision', 'Progress reports'].map((item, i) => (
                      <li key={i} className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  >
                    Access as Facilitator <ArrowRight className="h-4 w-4 ml-1 inline" />
                  </Button>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
                ...
                <span className="text-sm font-medium text-amber-600 dark:text-amber-400">Testimonials</span>
              </div>
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-4">
                Stories of
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Hear from practitioners who have experienced the power of Shadanga Kriya.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8">
                ...
                <span className="text-sm font-medium text-primary">Start Your Practice Today</span>
              </div>
              
              <h2 className="font-serif text-4xl md:text-6xl font-bold text-foreground mb-6">
                Ready to Begin Your
                <span className="block gradient-text-brand">Healing Journey?</span>
              </h2>
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                Join thousands of practitioners who have discovered inner peace and clarity through Shadanga Kriya. Your transformation starts with a single step.
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Ancient wisdom for modern healing. Experience transformation through authentic practice.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-foreground mb-4">Platform</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="hover:text-primary cursor-pointer transition-colors">Learner App</li>
                <li className="hover:text-primary cursor-pointer transition-colors">Admin Dashboard</li>
                <li className="hover:text-primary cursor-pointer transition-colors">Facilitator Panel</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="hover:text-primary cursor-pointer transition-colors">Our Teachers</li>
