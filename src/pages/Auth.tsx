...
import { Eye, EyeOff, HelpCircle, User, Users, BarChart3, ArrowLeft, Mail, Lock, UserCircle, Sparkles, Sunrise } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col relative">
        ...
        <div className="absolute top-20 right-10 w-64 h-64 rounded-full blur-3xl opacity-10"
          style={{ background: 'radial-gradient(circle, hsl(174 65% 40%) 0%, transparent 70%)' }}
        />
          ...
          <div className="w-full max-w-md animate-fade-in">
            ...
            {mode === 'signup' && (
              <div className="mb-8 animate-fade-in">
                <Label className="text-sm font-medium mb-3 block text-foreground">I am joining as...</Label>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {mode === 'login' && (
                <div className="flex items-center justify-end">
                  <button type="button" className="text-sm text-primary hover:text-primary/80 hover:underline font-medium transition-colors">
                    Forgot password?
                  </button>
                </div>
              )}
              ...
              <div className="mt-6 p-5 bg-gradient-to-br from-primary/10 to-teal-500/10 rounded-2xl border border-primary/20 animate-fade-in">
                ...
                <div className="text-xs text-muted-foreground space-y-1.5">
                  <p className="flex items-center gap-2">
                    ...
                    Admin: admin@therapyos.com / admin123
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-teal-600"></span>
                    Facilitator: facilitator@therapyos.com / facilitator123
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-teal-500"></span>
                    Learner: learner@therapyos.com / learner123
                  </p>
                </div>
              </div>
            )}
