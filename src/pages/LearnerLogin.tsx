...
import { Eye, EyeOff, HelpCircle, Sparkles, Heart, Sunrise } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div 
          ...
          style={{ background: 'radial-gradient(circle, hsl(174 65% 40% / 0.4) 0%, transparent 70%)' }}
        />
        <div 
          className="absolute bottom-20 right-5 w-48 h-48 rounded-full blur-3xl opacity-25 animate-float"
          style={{ background: 'radial-gradient(circle, hsl(38 85% 55% / 0.4) 0%, transparent 70%)', animationDelay: '1.5s' }}
        />
        <div 
          className="absolute top-1/3 right-10 w-32 h-32 rounded-full blur-2xl opacity-20 animate-pulse-gentle"
          style={{ background: 'radial-gradient(circle, hsl(180 50% 45% / 0.5) 0%, transparent 70%)' }}
        />
      </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-12 relative z-10">
        <div className="w-full max-w-sm">
          ...
          {/* Login Form */}
          <form onSubmit={handleLogin} className="space-y-5 animate-fade-in-up animation-fill-both animate-delay-200">
          ...
          <div className="mt-8 p-5 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 animate-fade-in-up animation-fill-both animate-delay-400">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground mb-1">Need access?</p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Contact your facilitator or administrator to receive your login credentials.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 text-center animate-fade-in animate-delay-500">
            ...
            >
              Need more options? <span className="text-primary font-semibold hover:underline">Full Sign In</span>
            </button>
          </div>
        </div>
      </main>
