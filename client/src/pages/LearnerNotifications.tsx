...
import { CheckCheck, Bell, ChevronLeft, CheckCircle, AlertTriangle, Info } from 'lucide-react';
                ...
                <header className="sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border/50">
                    <div className="flex items-center gap-4 px-4 py-4 max-w-3xl mx-auto">
                        ...
                        <div>
                            ...
                            <h1 className="font-serif text-lg font-semibold">Your Updates</h1>
                        </div>
                    </div>
                </header>
            ...
            <main className="p-4 max-w-3xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex gap-2">
                        <Button
                            variant={filter === 'all' ? 'therapy' : 'outline'}
                        ...
                        <Button
                            variant={filter === 'unread' ? 'therapy' : 'outline'}
                ...
                <div className="space-y-3">
                    {notifications.length === 0 ? (
                        ...
                        notifications.map((notification: any) => (
                            <Card
                                key={notification.id}
                                className={`p-4 transition-all duration-200 ${!notification.is_read
