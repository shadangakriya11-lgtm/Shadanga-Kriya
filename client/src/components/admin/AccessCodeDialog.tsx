...
export function AccessCodeDialog({
  ...
  const [codeType, setCodeType] = useState<"permanent" | "temporary">(
    "permanent"
  );
          ...
          <div className="space-y-6">
            ...
            {codeInfo?.hasAccessCode && codeInfo.accessCode && (
              <div className="p-4 rounded-lg border bg-gradient-to-r from-primary/5 to-primary/10">
                ...
                {codeInfo.accessCode.type === "temporary" &&
                  codeInfo.accessCode.expiresAt && (
                    <p
            ...
            <div className="space-y-4 p-4 rounded-lg border">
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Select
                    value={codeType}
                    onValueChange={(v) =>
                      setCodeType(v as "permanent" | "temporary")
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                    ...
                    <div className="flex gap-2">
                      {[30, 60, 120, 1440].map((mins) => (
                        <Button
                          ...
                          type="button"
                          variant={
                            expiresInMinutes === mins ? "default" : "outline"
                          }
                          size="sm"
              ...
              <div className="flex gap-2">
                ...
                {/* Only show clear button if access code is disabled (not required) */}
                {codeInfo?.hasAccessCode && !codeInfo?.accessCodeEnabled && (
                  <Button
                    variant="outline"
